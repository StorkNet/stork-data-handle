...
contract StorkHandler {
    ...
    function createNewType(string calldata _storkName, bytes calldata _storkData)
        external
    {
    ...
    function createData(string memory _phalanxName, bytes memory _storkData) internal {
    ...
    /// @param _storkData The value of the data being stored
    function updateData(string memory _phalanxName, uint32 _storkId, bytes memory _storkData) internal {
        emit StorkUpdate(_phalanxName, _storkId, Stork({_id: _storkId, _data: _storkData}));
    }
    ...
    /// @param _phalanxName The StorkDataType
    /// @param _storkId The value of the data being stored
    function deleteData(string memory _phalanxName, uint32 _storkId) internal {
